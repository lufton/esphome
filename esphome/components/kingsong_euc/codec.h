...
class KingSongEUCCodec {
 ...
 public:
  ...
  std::unique_ptr<KingSongEUCBuffer> get_get_magic_light_request();
  ...
  std::unique_ptr<KingSongEUCBuffer> get_set_lift_sensor_request(bool state);
  std::unique_ptr<KingSongEUCBuffer> get_set_magic_light_request(bool state);
  std::unique_ptr<KingSongEUCBuffer> get_set_spectrum_light_request(bool state);
  std::unique_ptr<KingSongEUCBuffer> get_set_strobe_request(bool state);
