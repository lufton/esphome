...
class KingSongEUC : public ISendable, public ble_client::BLEClientNode, public PollingComponent {
 public:
  ...
  void send_request(KingSongEUCPacketTypes type, uint8_t value) override;
  void send_request(KingSongEUCPacketTypes type, uint8_t value, std::map<uint8_t, uint8_t> bytes) override;
  REGISTER_BINARY_SENSOR(charging)
  REGISTER_BINARY_SENSOR(fan)
  REGISTER_BINARY_SENSOR(light)
  ...
  REGISTER_SENSOR(motor_holzer)
  REGISTER_SENSOR(motor_line)
